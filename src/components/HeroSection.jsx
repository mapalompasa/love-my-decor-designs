  ...
  return (
    <section className="relative pt-28 md:pt-36 pb-12 md:pb-20 overflow-hidden">
      <div className="max-w-[1720px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Editorial Sub-bar */}
        <div className="flex flex-wrap items-center justify-between gap-2 text-xs md:text-sm font-bold uppercase tracking-wider text-neutral-400 mb-4 md:mb-6">
          ...
          <div className="flex items-center gap-4">
            <span className="hidden sm:inline">Direct Concierge:</span>
            <a
              href={`https://wa.me/${brandConfig.whatsappNumber}`}
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-luxury-cream underline underline-offset-4 flex items-center gap-1.5"
            >
        ...
        <div className="mb-6 md:mb-10 select-none">
          <h1 className="text-[11vw] sm:text-[12vw] md:text-[12.5vw] font-[900] tracking-tighter uppercase leading-[0.88] text-white">
            LOVE MY DECOR
          </h1>
          <div className="flex flex-col md:flex-row md:items-baseline justify-between mt-2 md:mt-4 gap-2">
            <span className="text-xl sm:text-3xl md:text-5xl lg:text-6xl font-[900] tracking-tight uppercase text-neutral-300">
              Bespoke Event Design &amp; Luxury Styling
            </span>
            <span className="text-xs sm:text-sm uppercase font-mono tracking-widest text-[#c966d4] flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-[#c966d4]"></span>
        ...
        <div className="grid grid-cols-8 md:grid-cols-16 gap-x-6 gap-y-8 md:gap-y-10 text-sm">
          ...
          <div className="col-span-8 md:col-span-8 lg:col-span-7 flex flex-col justify-between border-b md:border-b-0 lg:border-b-0 border-white/10 pb-6 md:pb-0">
            <div className="space-y-4">
              ...
              <p className="text-base sm:text-lg md:text-xl font-medium leading-relaxed text-neutral-200">
          ...
          <div className="col-span-8 md:col-span-16 lg:col-span-5 flex flex-col justify-between gap-6">
            <div className="p-6 bg-[#120d14] border border-[#2c1930] relative overflow-hidden group">
              <img
                src="/logo.jpg"
                alt="Love My Decor Logo Badge"
                className="absolute top-5 right-5 w-12 h-12 rounded-full border border-[#83338a] object-cover shadow-md opacity-90 group-hover:opacity-100 transition-opacity"
              />
              <p className="text-xs uppercase font-mono tracking-widest text-[#d6bdda] mb-2">
                Commission Inquiries
              </p>
              <p className="text-lg font-bold text-white mb-4 leading-tight max-w-[220px]">
              ...
              <a
                href="#booking"
                className="w-full flex items-center justify-between px-5 py-4 bg-[#83338a] text-white font-[900] text-xs uppercase tracking-tight hover:bg-[#993da3] transition-all shadow-lg shadow-[#83338a]/20 group border border-[#c966d4]/40"
              >
              ...
              <a
                href="#portfolio"
                className="w-full mt-3 flex items-center justify-between px-5 py-3 border border-white/20 text-white font-bold text-xs uppercase tracking-tight hover:bg-[#83338a]/15 transition-all group"
              >
            ...
            <div className="flex items-center justify-between px-4 py-3 border border-white/10 bg-white/[0.02] text-xs">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#c966d4] font-bold hover:underline flex items-center gap-1.5"
              >
                <IconWhatsApp className="w-3.5 h-3.5 fill-current" />
