      ...
      <div className="max-w-[1720px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 md:mb-16">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
            <div>
              <span className="text-xs uppercase font-mono tracking-widest text-luxury-gold flex items-center gap-2 mb-2">
                <IconSparkles className="w-3.5 h-3.5 stroke-luxury-gold" />
        ...
        <div className="grid grid-cols-8 md:grid-cols-16 gap-8 md:gap-12 items-center">
          ...
          <div className="col-span-8 md:col-span-8 lg:col-span-7">
            <div className="relative aspect-[4/5] w-full overflow-hidden bg-[#120d14] border border-[#2c1930] group">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                ...
                <p className="text-2xl sm:text-3xl font-[900] uppercase tracking-tight text-white">
                  Selina Machima
                </p>
          ...
          <div className="col-span-8 md:col-span-8 lg:col-span-9 space-y-6 md:space-y-8">
            ...
            <div className="space-y-4">
              <blockquote className="text-lg sm:text-2xl md:text-3xl font-[900] uppercase tracking-tight leading-snug text-neutral-100">
